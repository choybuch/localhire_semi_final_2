            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                <div className='flex items-center gap-4 mb-8 text-gray-500'>
                    <label htmlFor="con-img">
                        <img className='w-16 bg-gray-100 rounded-full cursor-pointer' src={conImg ? URL.createObjectURL(conImg) : assets.upload_area} alt="" />
                    </label>
                    <input onChange={(e) => setConImg(e.target.files[0])} type="file" name="" id="con-img" hidden />
